...
function CatalogueLinksView({ catalogues, links, files, articles, vendors, onMutate, onOpenFile }: {
  ...
  const saveCatalogueLink = (event: React.FormEvent) => {
    ...
    const catalogueId = draft.catalogueId || genId("catalogue");
    ...
    const newLink: CatalogueArticleVendorLink = { id: genId("catalogue-link"), catalogue_id: catalogueId, article_id: draft.articleId, vendor_id: draft.vendorId || undefined, notes: draft.notes.trim() || undefined, status: "active", created_at: timestamp, updated_at: timestamp };
