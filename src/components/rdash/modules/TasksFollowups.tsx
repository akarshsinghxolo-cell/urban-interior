    ...
    return (<div className="flex flex-col gap-5">
      <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
        ...
        {!isFollowupBoard && (<div className="flex w-full flex-wrap items-center gap-2 sm:w-auto sm:flex-nowrap">
            ...
            <button type="button" onClick={() => openCreateDialog({ kind: "task" })} className="inline-flex shrink-0 items-center gap-1.5 whitespace-nowrap rounded-md bg-primary px-3 py-1.5 text-xs font-semibold text-primary-foreground shadow-sm transition-all duration-150 hover:bg-primary/90 active:scale-95">
              <Plus className="h-3.5 w-3.5"/> New task
            </button>
            <button type="button" onClick={() => setCreateFollowupOpen(true)} className="inline-flex shrink-0 items-center gap-1.5 whitespace-nowrap rounded-md border border-primary bg-primary/10 px-3 py-1.5 text-xs font-semibold text-primary transition-all duration-150 hover:bg-primary/15 active:scale-95">
