...
import { readGoogleDriveOAuthConfig, saveGoogleDriveOAuthConfig } from "@/lib/rdash/server/drive-connections";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const config = await readGoogleDriveOAuthConfig(origin);
