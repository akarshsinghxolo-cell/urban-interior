...
export async function POST(request: NextRequest) {
  try {
    ...
    const updatedInstances = folderInstanceExists ? existingInstances : [...existingInstances, uploaded.storageFolderInstance];
    ...
    const newAttachment = {
      ...
      role: role || "media", caption: caption || undefined,
      visibility: visibility as any, customer_shareable: customerShareable,
      status: "active" as const, created_at: timestamp, updated_at: timestamp,
    };
