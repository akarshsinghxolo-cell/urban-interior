        ...
        modules: [
            {
                ...
                submodules: [
                    ...
                    { id: "jobPnlReport", label: "Site / Work Order P&L", renderer: "reports-v2", dataSource: "workOrders" },
        ...
        modules: [
            {
                ...
                description: "Users, roles, staff, attendance policies, data tools and system controls",
                icon: "⚙️",
                renderer: "system",
                dataSource: "none",
                submodules: [
