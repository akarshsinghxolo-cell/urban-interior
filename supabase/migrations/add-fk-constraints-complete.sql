...
-- ============================================================================
-- Generated from fk-registry.ts. All table names double-quoted for camelCase.
-- No ON DELETE actions (Postgres limitation with generated columns).
-- The app-layer cascade planner (cascade.ts) handles deletions.
-- ============================================================================
...
ALTER TABLE "entity_measurementRevisions" ADD COLUMN IF NOT EXISTS "area_id_gen" text GENERATED ALWAYS AS (data->>'area_id') STORED;
...
ALTER TABLE "entity_measurementRevisions" ADD COLUMN IF NOT EXISTS "work_required_id_gen" text GENERATED ALWAYS AS (data->>'work_required_id') STORED;
...
ALTER TABLE "entity_measurementRevisions" ADD COLUMN IF NOT EXISTS "drawing_id_gen" text GENERATED ALWAYS AS (data->>'drawing_id') STORED;
...
ALTER TABLE "entity_acceptedScopes" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_acceptedScopes" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_acceptedScopes" ADD COLUMN IF NOT EXISTS "work_required_id_gen" text GENERATED ALWAYS AS (data->>'work_required_id') STORED;
...
ALTER TABLE "entity_acceptedScopes" ADD COLUMN IF NOT EXISTS "quotation_id_gen" text GENERATED ALWAYS AS (data->>'quotation_id') STORED;
...
ALTER TABLE "entity_vendorRfqs" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_vendorRfqs" ADD COLUMN IF NOT EXISTS "boq_id_gen" text GENERATED ALWAYS AS (data->>'boq_id') STORED;
...
ALTER TABLE "entity_vendorRfqs" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_vendorBids" ADD COLUMN IF NOT EXISTS "rfq_id_gen" text GENERATED ALWAYS AS (data->>'rfq_id') STORED;
...
ALTER TABLE "entity_vendorBids" ADD COLUMN IF NOT EXISTS "vendor_id_gen" text GENERATED ALWAYS AS (data->>'vendor_id') STORED;
...
ALTER TABLE "entity_purchaseOrders" ADD COLUMN IF NOT EXISTS "rfq_id_gen" text GENERATED ALWAYS AS (data->>'rfq_id') STORED;
...
ALTER TABLE "entity_purchaseOrders" ADD COLUMN IF NOT EXISTS "vendor_id_gen" text GENERATED ALWAYS AS (data->>'vendor_id') STORED;
...
ALTER TABLE "entity_purchaseOrders" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_grns" ADD COLUMN IF NOT EXISTS "vendor_id_gen" text GENERATED ALWAYS AS (data->>'vendor_id') STORED;
...
ALTER TABLE "entity_grns" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_grns" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_dispatches" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_dispatches" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_inventory" ADD COLUMN IF NOT EXISTS "grn_id_gen" text GENERATED ALWAYS AS (data->>'grn_id') STORED;
...
ALTER TABLE "entity_inventory" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_inventory" ADD COLUMN IF NOT EXISTS "article_id_gen" text GENERATED ALWAYS AS (data->>'article_id') STORED;
...
ALTER TABLE "entity_inventory" ADD COLUMN IF NOT EXISTS "work_required_article_id_gen" text GENERATED ALWAYS AS (data->>'work_required_article_id') STORED;
...
ALTER TABLE "entity_stockMovements" ADD COLUMN IF NOT EXISTS "inventory_id_gen" text GENERATED ALWAYS AS (data->>'inventory_id') STORED;
...
ALTER TABLE "entity_stockMovements" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_stockMovements" ADD COLUMN IF NOT EXISTS "po_id_gen" text GENERATED ALWAYS AS (data->>'po_id') STORED;
...
ALTER TABLE "entity_stockMovements" ADD COLUMN IF NOT EXISTS "grn_id_gen" text GENERATED ALWAYS AS (data->>'grn_id') STORED;
...
ALTER TABLE "entity_stockMovements" ADD COLUMN IF NOT EXISTS "dispatch_id_gen" text GENERATED ALWAYS AS (data->>'dispatch_id') STORED;
...
ALTER TABLE "entity_vendorBills" ADD COLUMN IF NOT EXISTS "po_id_gen" text GENERATED ALWAYS AS (data->>'po_id') STORED;
...
ALTER TABLE "entity_vendorBills" ADD COLUMN IF NOT EXISTS "grn_id_gen" text GENERATED ALWAYS AS (data->>'grn_id') STORED;
...
ALTER TABLE "entity_vendorBills" ADD COLUMN IF NOT EXISTS "vendor_id_gen" text GENERATED ALWAYS AS (data->>'vendor_id') STORED;
...
ALTER TABLE "entity_vendorBills" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_vendorBills" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_vendorPayments" ADD COLUMN IF NOT EXISTS "vendor_bill_id_gen" text GENERATED ALWAYS AS (data->>'vendor_bill_id') STORED;
...
ALTER TABLE "entity_vendorPayments" ADD COLUMN IF NOT EXISTS "vendor_id_gen" text GENERATED ALWAYS AS (data->>'vendor_id') STORED;
...
ALTER TABLE "entity_vendorPayments" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_vendorPayments" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_contractorBills" ADD COLUMN IF NOT EXISTS "contractor_id_gen" text GENERATED ALWAYS AS (data->>'contractor_id') STORED;
...
ALTER TABLE "entity_contractorBills" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_contractorBills" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_contractorBills" ADD COLUMN IF NOT EXISTS "work_required_id_gen" text GENERATED ALWAYS AS (data->>'work_required_id') STORED;
...
ALTER TABLE "entity_contractorPayments" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_contractorPayments" ADD COLUMN IF NOT EXISTS "contractor_id_gen" text GENERATED ALWAYS AS (data->>'contractor_id') STORED;
...
ALTER TABLE "entity_commissions" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_commissions" ADD COLUMN IF NOT EXISTS "source_partner_id_gen" text GENERATED ALWAYS AS (data->>'source_partner_id') STORED;
...
ALTER TABLE "entity_commissions" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_commissions" ADD COLUMN IF NOT EXISTS "quotation_id_gen" text GENERATED ALWAYS AS (data->>'quotation_id') STORED;
...
ALTER TABLE "entity_workOrderCostLines" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_contractorBids" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_contractorBids" ADD COLUMN IF NOT EXISTS "contractor_id_gen" text GENERATED ALWAYS AS (data->>'contractor_id') STORED;
...
ALTER TABLE "entity_contractorBids" ADD COLUMN IF NOT EXISTS "accepted_scope_id_gen" text GENERATED ALWAYS AS (data->>'accepted_scope_id') STORED;
...
ALTER TABLE "entity_contractorSettlements" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_contractorSettlements" ADD COLUMN IF NOT EXISTS "contractor_id_gen" text GENERATED ALWAYS AS (data->>'contractor_id') STORED;
...
ALTER TABLE "entity_drawings" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_drawings" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_drawings" ADD COLUMN IF NOT EXISTS "area_id_gen" text GENERATED ALWAYS AS (data->>'area_id') STORED;
...
ALTER TABLE "entity_executionLogs" ADD COLUMN IF NOT EXISTS "filed_by_staff_id_gen" text GENERATED ALWAYS AS (data->>'filed_by_staff_id') STORED;
...
ALTER TABLE "entity_executionLogs" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_variationRequests" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_variationRequests" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_variationRequests" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_visits" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_visits" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_visits" ADD COLUMN IF NOT EXISTS "work_required_id_gen" text GENERATED ALWAYS AS (data->>'work_required_id') STORED;
...
ALTER TABLE "entity_visits" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_visits" ADD COLUMN IF NOT EXISTS "staff_id_gen" text GENERATED ALWAYS AS (data->>'staff_id') STORED;
...
ALTER TABLE "entity_visits" ADD COLUMN IF NOT EXISTS "contractor_id_gen" text GENERATED ALWAYS AS (data->>'contractor_id') STORED;
...
ALTER TABLE "entity_visits" ADD COLUMN IF NOT EXISTS "vendor_id_gen" text GENERATED ALWAYS AS (data->>'vendor_id') STORED;
...
ALTER TABLE "entity_tasks" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_tasks" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_tasks" ADD COLUMN IF NOT EXISTS "quotation_id_gen" text GENERATED ALWAYS AS (data->>'quotation_id') STORED;
...
ALTER TABLE "entity_tasks" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_tasks" ADD COLUMN IF NOT EXISTS "visit_id_gen" text GENERATED ALWAYS AS (data->>'visit_id') STORED;
...
ALTER TABLE "entity_tasks" ADD COLUMN IF NOT EXISTS "po_id_gen" text GENERATED ALWAYS AS (data->>'po_id') STORED;
...
ALTER TABLE "entity_tasks" ADD COLUMN IF NOT EXISTS "work_required_id_gen" text GENERATED ALWAYS AS (data->>'work_required_id') STORED;
...
ALTER TABLE "entity_followups" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_followups" ADD COLUMN IF NOT EXISTS "quotation_id_gen" text GENERATED ALWAYS AS (data->>'quotation_id') STORED;
...
ALTER TABLE "entity_followups" ADD COLUMN IF NOT EXISTS "payment_id_gen" text GENERATED ALWAYS AS (data->>'payment_id') STORED;
...
ALTER TABLE "entity_followups" ADD COLUMN IF NOT EXISTS "visit_id_gen" text GENERATED ALWAYS AS (data->>'visit_id') STORED;
...
ALTER TABLE "entity_followups" ADD COLUMN IF NOT EXISTS "work_required_id_gen" text GENERATED ALWAYS AS (data->>'work_required_id') STORED;
...
ALTER TABLE "entity_actions" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_payments" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_payments" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_payments" ADD COLUMN IF NOT EXISTS "quotation_id_gen" text GENERATED ALWAYS AS (data->>'quotation_id') STORED;
...
ALTER TABLE "entity_payments" ADD COLUMN IF NOT EXISTS "work_required_id_gen" text GENERATED ALWAYS AS (data->>'work_required_id') STORED;
...
ALTER TABLE "entity_payments" ADD COLUMN IF NOT EXISTS "invoice_id_gen" text GENERATED ALWAYS AS (data->>'invoice_id') STORED;
...
ALTER TABLE "entity_invoices" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_invoices" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_invoices" ADD COLUMN IF NOT EXISTS "quotation_id_gen" text GENERATED ALWAYS AS (data->>'quotation_id') STORED;
...
ALTER TABLE "entity_invoices" ADD COLUMN IF NOT EXISTS "work_required_id_gen" text GENERATED ALWAYS AS (data->>'work_required_id') STORED;
...
ALTER TABLE "entity_invoices" ADD COLUMN IF NOT EXISTS "payment_id_gen" text GENERATED ALWAYS AS (data->>'payment_id') STORED;
...
ALTER TABLE "entity_customerReceipts" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_customerReceipts" ADD COLUMN IF NOT EXISTS "invoice_id_gen" text GENERATED ALWAYS AS (data->>'invoice_id') STORED;
...
ALTER TABLE "entity_customerReceipts" ADD COLUMN IF NOT EXISTS "payment_id_gen" text GENERATED ALWAYS AS (data->>'payment_id') STORED;
...
ALTER TABLE "entity_customerReceipts" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_customerReceipts" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_blocked" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_blocked" ADD COLUMN IF NOT EXISTS "linked_work_order_id_gen" text GENERATED ALWAYS AS (data->>'linked_work_order_id') STORED;
...
ALTER TABLE "entity_blocked" ADD COLUMN IF NOT EXISTS "linked_po_id_gen" text GENERATED ALWAYS AS (data->>'linked_po_id') STORED;
...
ALTER TABLE "entity_blocked" ADD COLUMN IF NOT EXISTS "linked_grn_id_gen" text GENERATED ALWAYS AS (data->>'linked_grn_id') STORED;
...
ALTER TABLE "entity_blocked" ADD COLUMN IF NOT EXISTS "linked_task_id_gen" text GENERATED ALWAYS AS (data->>'linked_task_id') STORED;
...
ALTER TABLE "entity_risks" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_commSends" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_commSends" ADD COLUMN IF NOT EXISTS "followup_id_gen" text GENERATED ALWAYS AS (data->>'followup_id') STORED;
...
ALTER TABLE "entity_commSends" ADD COLUMN IF NOT EXISTS "task_id_gen" text GENERATED ALWAYS AS (data->>'task_id') STORED;
...
ALTER TABLE "entity_commSends" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_commSends" ADD COLUMN IF NOT EXISTS "quotation_id_gen" text GENERATED ALWAYS AS (data->>'quotation_id') STORED;
...
ALTER TABLE "entity_attendance" ADD COLUMN IF NOT EXISTS "staff_id_gen" text GENERATED ALWAYS AS (data->>'staff_id') STORED;
...
ALTER TABLE "entity_attendance" ADD COLUMN IF NOT EXISTS "visit_id_gen" text GENERATED ALWAYS AS (data->>'visit_id') STORED;
...
ALTER TABLE "entity_staffLocationPings" ADD COLUMN IF NOT EXISTS "staff_id_gen" text GENERATED ALWAYS AS (data->>'staff_id') STORED;
...
ALTER TABLE "entity_leaveRequests" ADD COLUMN IF NOT EXISTS "staff_id_gen" text GENERATED ALWAYS AS (data->>'staff_id') STORED;
...
ALTER TABLE "entity_payrollLines" ADD COLUMN IF NOT EXISTS "payroll_period_id_gen" text GENERATED ALWAYS AS (data->>'payroll_period_id') STORED;
...
ALTER TABLE "entity_payrollLines" ADD COLUMN IF NOT EXISTS "staff_id_gen" text GENERATED ALWAYS AS (data->>'staff_id') STORED;
...
ALTER TABLE "entity_salaryAdjustments" ADD COLUMN IF NOT EXISTS "staff_id_gen" text GENERATED ALWAYS AS (data->>'staff_id') STORED;
...
ALTER TABLE "entity_salaryAdjustments" ADD COLUMN IF NOT EXISTS "payroll_period_id_gen" text GENERATED ALWAYS AS (data->>'payroll_period_id') STORED;
...
ALTER TABLE "entity_staffDocuments" ADD COLUMN IF NOT EXISTS "staff_id_gen" text GENERATED ALWAYS AS (data->>'staff_id') STORED;
...
ALTER TABLE "entity_staffDocuments" ADD COLUMN IF NOT EXISTS "file_asset_id_gen" text GENERATED ALWAYS AS (data->>'file_asset_id') STORED;
...
ALTER TABLE "entity_recurringTasks" ADD COLUMN IF NOT EXISTS "assignee_id_gen" text GENERATED ALWAYS AS (data->>'assignee_id') STORED;
...
ALTER TABLE "entity_entityFileAttachments" ADD COLUMN IF NOT EXISTS "file_asset_id_gen" text GENERATED ALWAYS AS (data->>'file_asset_id') STORED;
...
ALTER TABLE "entity_entityReferenceAssignments" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_master_vendorRates" ADD COLUMN IF NOT EXISTS "work_required_article_id_gen" text GENERATED ALWAYS AS (data->>'work_required_article_id') STORED;
...
ALTER TABLE "entity_master_vendorRates" ADD COLUMN IF NOT EXISTS "article_id_gen" text GENERATED ALWAYS AS (data->>'article_id') STORED;
...
ALTER TABLE "entity_master_vendorRateHistories" ADD COLUMN IF NOT EXISTS "vendor_rate_id_gen" text GENERATED ALWAYS AS (data->>'vendor_rate_id') STORED;
...
ALTER TABLE "entity_master_vendorRateHistories" ADD COLUMN IF NOT EXISTS "vendor_id_gen" text GENERATED ALWAYS AS (data->>'vendor_id') STORED;
...
ALTER TABLE "entity_master_vendorRateHistories" ADD COLUMN IF NOT EXISTS "article_id_gen" text GENERATED ALWAYS AS (data->>'article_id') STORED;
...
ALTER TABLE "entity_master_vendorRateHistories" ADD COLUMN IF NOT EXISTS "work_required_article_id_gen" text GENERATED ALWAYS AS (data->>'work_required_article_id') STORED;
...
ALTER TABLE "entity_master_articleVariants" ADD COLUMN IF NOT EXISTS "article_id_gen" text GENERATED ALWAYS AS (data->>'article_id') STORED;
...
ALTER TABLE "entity_master_articleVariants" ADD COLUMN IF NOT EXISTS "work_required_article_id_gen" text GENERATED ALWAYS AS (data->>'work_required_article_id') STORED;
...
ALTER TABLE "entity_master_subcategoryArticleMap" ADD COLUMN IF NOT EXISTS "article_id_gen" text GENERATED ALWAYS AS (data->>'article_id') STORED;
...
ALTER TABLE "entity_master_subcategoryArticleMap" ADD COLUMN IF NOT EXISTS "work_required_id_gen" text GENERATED ALWAYS AS (data->>'work_required_id') STORED;
...
ALTER TABLE "entity_master_storageFolderInstances" ADD COLUMN IF NOT EXISTS "template_id_gen" text GENERATED ALWAYS AS (data->>'template_id') STORED;
...
ALTER TABLE "entity_master_fileAssets" ADD COLUMN IF NOT EXISTS "storage_account_id_gen" text GENERATED ALWAYS AS (data->>'storage_account_id') STORED;
...
ALTER TABLE "entity_master_fileAssets" ADD COLUMN IF NOT EXISTS "storage_folder_instance_id_gen" text GENERATED ALWAYS AS (data->>'storage_folder_instance_id') STORED;
...
ALTER TABLE "entity_master_catalogueArticleVendorLinks" ADD COLUMN IF NOT EXISTS "catalogue_id_gen" text GENERATED ALWAYS AS (data->>'catalogue_id') STORED;
...
ALTER TABLE "entity_master_catalogueArticleVendorLinks" ADD COLUMN IF NOT EXISTS "article_id_gen" text GENERATED ALWAYS AS (data->>'article_id') STORED;
...
ALTER TABLE "entity_master_catalogueArticleVendorLinks" ADD COLUMN IF NOT EXISTS "vendor_id_gen" text GENERATED ALWAYS AS (data->>'vendor_id') STORED;
...
ALTER TABLE "entity_master_commissionRules" ADD COLUMN IF NOT EXISTS "source_partner_id_gen" text GENERATED ALWAYS AS (data->>'source_partner_id') STORED;
...
ALTER TABLE "entity_master_commissionRules" ADD COLUMN IF NOT EXISTS "category_id_gen" text GENERATED ALWAYS AS (data->>'category_id') STORED;
...
ALTER TABLE "entity_master_pinterestBoards" ADD COLUMN IF NOT EXISTS "category_id_gen" text GENERATED ALWAYS AS (data->>'category_id') STORED;
...
ALTER TABLE "entity_master_pinterestBoards" ADD COLUMN IF NOT EXISTS "subcategory_id_gen" text GENERATED ALWAYS AS (data->>'subcategory_id') STORED;
...
ALTER TABLE "entity_master_pinterestBoards" ADD COLUMN IF NOT EXISTS "article_id_gen" text GENERATED ALWAYS AS (data->>'article_id') STORED;
...
ALTER TABLE "entity_master_referenceMedia" ADD COLUMN IF NOT EXISTS "category_id_gen" text GENERATED ALWAYS AS (data->>'category_id') STORED;
...
ALTER TABLE "entity_master_referenceMedia" ADD COLUMN IF NOT EXISTS "subcategory_id_gen" text GENERATED ALWAYS AS (data->>'subcategory_id') STORED;
...
ALTER TABLE "entity_master_referenceMedia" ADD COLUMN IF NOT EXISTS "article_id_gen" text GENERATED ALWAYS AS (data->>'article_id') STORED;
...
ALTER TABLE "entity_master_catalogues" ADD COLUMN IF NOT EXISTS "drive_asset_id_gen" text GENERATED ALWAYS AS (data->>'drive_asset_id') STORED;
...
ALTER TABLE "entity_visits" ADD COLUMN IF NOT EXISTS "recovery_followup_id_gen" text GENERATED ALWAYS AS (data->>'recovery_followup_id') STORED;
...
ALTER TABLE "entity_visits" ADD COLUMN IF NOT EXISTS "report_task_id_gen" text GENERATED ALWAYS AS (data->>'report_task_id') STORED;
...
ALTER TABLE "entity_visits" ADD COLUMN IF NOT EXISTS "checkout_thread_message_id_gen" text GENERATED ALWAYS AS (data->>'checkout_thread_message_id') STORED;
...
ALTER TABLE "entity_visits" ADD COLUMN IF NOT EXISTS "report_thread_message_id_gen" text GENERATED ALWAYS AS (data->>'report_thread_message_id') STORED;
...
ALTER TABLE "entity_tasks" ADD COLUMN IF NOT EXISTS "blocked_item_id_gen" text GENERATED ALWAYS AS (data->>'blocked_item_id') STORED;
...
ALTER TABLE "entity_payments" ADD COLUMN IF NOT EXISTS "milestone_term_id_gen" text GENERATED ALWAYS AS (data->>'milestone_term_id') STORED;
...
ALTER TABLE "entity_workOrders" ADD COLUMN IF NOT EXISTS "abandoned_contractor_id_gen" text GENERATED ALWAYS AS (data->>'abandoned_contractor_id') STORED;
...
ALTER TABLE "entity_grns" ADD COLUMN IF NOT EXISTS "bill_id_gen" text GENERATED ALWAYS AS (data->>'bill_id') STORED;
...
ALTER TABLE "entity_vendorBills" ADD COLUMN IF NOT EXISTS "three_way_match_obstacle_id_gen" text GENERATED ALWAYS AS (data->>'three_way_match.obstacle_id') STORED;
...
ALTER TABLE "entity_variationRequests" ADD COLUMN IF NOT EXISTS "execution_log_id_gen" text GENERATED ALWAYS AS (data->>'execution_log_id') STORED;
...
ALTER TABLE "entity_threadMessages" ADD COLUMN IF NOT EXISTS "related_thread_id_gen" text GENERATED ALWAYS AS (data->>'related_thread_id') STORED;
...
ALTER TABLE "entity_threadMessages" ADD COLUMN IF NOT EXISTS "related_audit_id_gen" text GENERATED ALWAYS AS (data->>'related_audit_id') STORED;
...
ALTER TABLE "entity_threadMessageAttachments" ADD COLUMN IF NOT EXISTS "entity_file_attachment_id_gen" text GENERATED ALWAYS AS (data->>'entity_file_attachment_id') STORED;
...
ALTER TABLE "entity_customers" ADD COLUMN IF NOT EXISTS "source_partner_id_gen" text GENERATED ALWAYS AS (data->>'source_partner_id') STORED;
...
ALTER TABLE "entity_sites" ADD COLUMN IF NOT EXISTS "source_partner_id_gen" text GENERATED ALWAYS AS (data->>'source_partner_id') STORED;
...
ALTER TABLE "entity_acceptedScopes" ADD COLUMN IF NOT EXISTS "contractor_bid_id_gen" text GENERATED ALWAYS AS (data->>'contractor_bid_id') STORED;
...
ALTER TABLE "entity_contractorSettlements" ADD COLUMN IF NOT EXISTS "replacement_work_order_id_gen" text GENERATED ALWAYS AS (data->>'replacement_work_order_id') STORED;
...
ALTER TABLE "entity_leaveRequests" ADD COLUMN IF NOT EXISTS "approved_by_staff_id_gen" text GENERATED ALWAYS AS (data->>'approved_by_staff_id') STORED;
...
ALTER TABLE "entity_attendance" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_salaryAdjustments" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_recurringTasks" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_recurringTasks" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_recurringTasks" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
...
ALTER TABLE "entity_blocked" ADD COLUMN IF NOT EXISTS "linked_quotation_id_gen" text GENERATED ALWAYS AS (data->>'linked_quotation_id') STORED;
...
ALTER TABLE "entity_master_fileAssets" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_master_fileAssets" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_master_storageFolderInstances" ADD COLUMN IF NOT EXISTS "customer_id_gen" text GENERATED ALWAYS AS (data->>'customer_id') STORED;
...
ALTER TABLE "entity_master_storageFolderInstances" ADD COLUMN IF NOT EXISTS "site_id_gen" text GENERATED ALWAYS AS (data->>'site_id') STORED;
...
ALTER TABLE "entity_master_storageFolderInstances" ADD COLUMN IF NOT EXISTS "work_order_id_gen" text GENERATED ALWAYS AS (data->>'work_order_id') STORED;
