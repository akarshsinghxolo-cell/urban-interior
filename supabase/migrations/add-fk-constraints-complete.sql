...
ALTER TABLE "entity_sites" ADD CONSTRAINT "entity_sites_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_areas" ADD CONSTRAINT "entity_areas_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_workRequired" ADD CONSTRAINT "entity_workRequired_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_workRequired" ADD CONSTRAINT "entity_workRequired_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_measurementRevisions" ADD CONSTRAINT "entity_measurementRevisions_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_measurementRevisions" ADD CONSTRAINT "entity_measurementRevisions_area_id_fkey" FOREIGN KEY ("area_id_gen") REFERENCES "entity_areas"(id) NOT VALID;
...
ALTER TABLE "entity_measurementRevisions" ADD CONSTRAINT "entity_measurementRevisions_work_required_id_fkey" FOREIGN KEY ("work_required_id_gen") REFERENCES "entity_workRequired"(id) NOT VALID;
...
ALTER TABLE "entity_measurementRevisions" ADD CONSTRAINT "entity_measurementRevisions_drawing_id_fkey" FOREIGN KEY ("drawing_id_gen") REFERENCES "entity_drawings"(id) NOT VALID;
...
ALTER TABLE "entity_quotations" ADD CONSTRAINT "entity_quotations_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_quotations" ADD CONSTRAINT "entity_quotations_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_acceptedScopes" ADD CONSTRAINT "entity_acceptedScopes_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_acceptedScopes" ADD CONSTRAINT "entity_acceptedScopes_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_acceptedScopes" ADD CONSTRAINT "entity_acceptedScopes_work_required_id_fkey" FOREIGN KEY ("work_required_id_gen") REFERENCES "entity_workRequired"(id) NOT VALID;
...
ALTER TABLE "entity_acceptedScopes" ADD CONSTRAINT "entity_acceptedScopes_quotation_id_fkey" FOREIGN KEY ("quotation_id_gen") REFERENCES "entity_quotations"(id) NOT VALID;
...
ALTER TABLE "entity_workOrders" ADD CONSTRAINT "entity_workOrders_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_workOrders" ADD CONSTRAINT "entity_workOrders_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_boqs" ADD CONSTRAINT "entity_boqs_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_vendorRfqs" ADD CONSTRAINT "entity_vendorRfqs_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_vendorRfqs" ADD CONSTRAINT "entity_vendorRfqs_boq_id_fkey" FOREIGN KEY ("boq_id_gen") REFERENCES "entity_boqs"(id) NOT VALID;
...
ALTER TABLE "entity_vendorRfqs" ADD CONSTRAINT "entity_vendorRfqs_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_vendorBids" ADD CONSTRAINT "entity_vendorBids_rfq_id_fkey" FOREIGN KEY ("rfq_id_gen") REFERENCES "entity_vendorRfqs"(id) NOT VALID;
...
ALTER TABLE "entity_vendorBids" ADD CONSTRAINT "entity_vendorBids_vendor_id_fkey" FOREIGN KEY ("vendor_id_gen") REFERENCES "entity_master_vendors"(id) NOT VALID;
...
ALTER TABLE "entity_purchaseOrders" ADD CONSTRAINT "entity_purchaseOrders_rfq_id_fkey" FOREIGN KEY ("rfq_id_gen") REFERENCES "entity_vendorRfqs"(id) NOT VALID;
...
ALTER TABLE "entity_purchaseOrders" ADD CONSTRAINT "entity_purchaseOrders_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_purchaseOrders" ADD CONSTRAINT "entity_purchaseOrders_vendor_id_fkey" FOREIGN KEY ("vendor_id_gen") REFERENCES "entity_master_vendors"(id) NOT VALID;
...
ALTER TABLE "entity_purchaseOrders" ADD CONSTRAINT "entity_purchaseOrders_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_grns" ADD CONSTRAINT "entity_grns_po_id_fkey" FOREIGN KEY ("po_id_gen") REFERENCES "entity_purchaseOrders"(id) NOT VALID;
...
ALTER TABLE "entity_grns" ADD CONSTRAINT "entity_grns_vendor_id_fkey" FOREIGN KEY ("vendor_id_gen") REFERENCES "entity_master_vendors"(id) NOT VALID;
...
ALTER TABLE "entity_grns" ADD CONSTRAINT "entity_grns_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_grns" ADD CONSTRAINT "entity_grns_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_dispatches" ADD CONSTRAINT "entity_dispatches_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_dispatches" ADD CONSTRAINT "entity_dispatches_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_inventory" ADD CONSTRAINT "entity_inventory_grn_id_fkey" FOREIGN KEY ("grn_id_gen") REFERENCES "entity_grns"(id) NOT VALID;
...
ALTER TABLE "entity_inventory" ADD CONSTRAINT "entity_inventory_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_inventory" ADD CONSTRAINT "entity_inventory_article_id_fkey" FOREIGN KEY ("article_id_gen") REFERENCES "entity_master_articles"(id) NOT VALID;
...
ALTER TABLE "entity_inventory" ADD CONSTRAINT "entity_inventory_work_required_article_id_fkey" FOREIGN KEY ("work_required_article_id_gen") REFERENCES "entity_master_subcategoryArticleMap"(id) NOT VALID;
...
ALTER TABLE "entity_stockMovements" ADD CONSTRAINT "entity_stockMovements_inventory_id_fkey" FOREIGN KEY ("inventory_id_gen") REFERENCES "entity_inventory"(id) NOT VALID;
...
ALTER TABLE "entity_stockMovements" ADD CONSTRAINT "entity_stockMovements_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_stockMovements" ADD CONSTRAINT "entity_stockMovements_po_id_fkey" FOREIGN KEY ("po_id_gen") REFERENCES "entity_purchaseOrders"(id) NOT VALID;
...
ALTER TABLE "entity_stockMovements" ADD CONSTRAINT "entity_stockMovements_grn_id_fkey" FOREIGN KEY ("grn_id_gen") REFERENCES "entity_grns"(id) NOT VALID;
...
ALTER TABLE "entity_stockMovements" ADD CONSTRAINT "entity_stockMovements_dispatch_id_fkey" FOREIGN KEY ("dispatch_id_gen") REFERENCES "entity_dispatches"(id) NOT VALID;
...
ALTER TABLE "entity_vendorBills" ADD CONSTRAINT "entity_vendorBills_po_id_fkey" FOREIGN KEY ("po_id_gen") REFERENCES "entity_purchaseOrders"(id) NOT VALID;
...
ALTER TABLE "entity_vendorBills" ADD CONSTRAINT "entity_vendorBills_grn_id_fkey" FOREIGN KEY ("grn_id_gen") REFERENCES "entity_grns"(id) NOT VALID;
...
ALTER TABLE "entity_vendorBills" ADD CONSTRAINT "entity_vendorBills_vendor_id_fkey" FOREIGN KEY ("vendor_id_gen") REFERENCES "entity_master_vendors"(id) NOT VALID;
...
ALTER TABLE "entity_vendorBills" ADD CONSTRAINT "entity_vendorBills_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_vendorBills" ADD CONSTRAINT "entity_vendorBills_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_vendorPayments" ADD CONSTRAINT "entity_vendorPayments_vendor_bill_id_fkey" FOREIGN KEY ("vendor_bill_id_gen") REFERENCES "entity_vendorBills"(id) NOT VALID;
...
ALTER TABLE "entity_vendorPayments" ADD CONSTRAINT "entity_vendorPayments_vendor_id_fkey" FOREIGN KEY ("vendor_id_gen") REFERENCES "entity_master_vendors"(id) NOT VALID;
...
ALTER TABLE "entity_vendorPayments" ADD CONSTRAINT "entity_vendorPayments_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_vendorPayments" ADD CONSTRAINT "entity_vendorPayments_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_contractorBills" ADD CONSTRAINT "entity_contractorBills_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_contractorBills" ADD CONSTRAINT "entity_contractorBills_contractor_id_fkey" FOREIGN KEY ("contractor_id_gen") REFERENCES "entity_master_contractors"(id) NOT VALID;
...
ALTER TABLE "entity_contractorBills" ADD CONSTRAINT "entity_contractorBills_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_contractorBills" ADD CONSTRAINT "entity_contractorBills_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_contractorBills" ADD CONSTRAINT "entity_contractorBills_work_required_id_fkey" FOREIGN KEY ("work_required_id_gen") REFERENCES "entity_workRequired"(id) NOT VALID;
...
ALTER TABLE "entity_contractorPayments" ADD CONSTRAINT "entity_contractorPayments_contractor_bill_id_fkey" FOREIGN KEY ("contractor_bill_id_gen") REFERENCES "entity_contractorBills"(id) NOT VALID;
...
ALTER TABLE "entity_contractorPayments" ADD CONSTRAINT "entity_contractorPayments_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_contractorPayments" ADD CONSTRAINT "entity_contractorPayments_contractor_id_fkey" FOREIGN KEY ("contractor_id_gen") REFERENCES "entity_master_contractors"(id) NOT VALID;
...
ALTER TABLE "entity_commissions" ADD CONSTRAINT "entity_commissions_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_commissions" ADD CONSTRAINT "entity_commissions_source_partner_id_fkey" FOREIGN KEY ("source_partner_id_gen") REFERENCES "entity_master_sourcePartners"(id) NOT VALID;
...
ALTER TABLE "entity_commissions" ADD CONSTRAINT "entity_commissions_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_commissions" ADD CONSTRAINT "entity_commissions_quotation_id_fkey" FOREIGN KEY ("quotation_id_gen") REFERENCES "entity_quotations"(id) NOT VALID;
...
ALTER TABLE "entity_workOrderCostLines" ADD CONSTRAINT "entity_workOrderCostLines_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_contractorBids" ADD CONSTRAINT "entity_contractorBids_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_contractorBids" ADD CONSTRAINT "entity_contractorBids_contractor_id_fkey" FOREIGN KEY ("contractor_id_gen") REFERENCES "entity_master_contractors"(id) NOT VALID;
...
ALTER TABLE "entity_contractorBids" ADD CONSTRAINT "entity_contractorBids_accepted_scope_id_fkey" FOREIGN KEY ("accepted_scope_id_gen") REFERENCES "entity_acceptedScopes"(id) NOT VALID;
...
ALTER TABLE "entity_contractorSettlements" ADD CONSTRAINT "entity_contractorSettlements_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_contractorSettlements" ADD CONSTRAINT "entity_contractorSettlements_contractor_id_fkey" FOREIGN KEY ("contractor_id_gen") REFERENCES "entity_master_contractors"(id) NOT VALID;
...
ALTER TABLE "entity_drawings" ADD CONSTRAINT "entity_drawings_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_drawings" ADD CONSTRAINT "entity_drawings_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_drawings" ADD CONSTRAINT "entity_drawings_area_id_fkey" FOREIGN KEY ("area_id_gen") REFERENCES "entity_areas"(id) NOT VALID;
...
ALTER TABLE "entity_executionLogs" ADD CONSTRAINT "entity_executionLogs_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_executionLogs" ADD CONSTRAINT "entity_executionLogs_filed_by_staff_id_fkey" FOREIGN KEY ("filed_by_staff_id_gen") REFERENCES "entity_master_staff"(id) NOT VALID;
...
ALTER TABLE "entity_executionLogs" ADD CONSTRAINT "entity_executionLogs_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_variationRequests" ADD CONSTRAINT "entity_variationRequests_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_variationRequests" ADD CONSTRAINT "entity_variationRequests_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_variationRequests" ADD CONSTRAINT "entity_variationRequests_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_visits" ADD CONSTRAINT "entity_visits_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_visits" ADD CONSTRAINT "entity_visits_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_visits" ADD CONSTRAINT "entity_visits_work_required_id_fkey" FOREIGN KEY ("work_required_id_gen") REFERENCES "entity_workRequired"(id) NOT VALID;
...
ALTER TABLE "entity_visits" ADD CONSTRAINT "entity_visits_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_visits" ADD CONSTRAINT "entity_visits_staff_id_fkey" FOREIGN KEY ("staff_id_gen") REFERENCES "entity_master_staff"(id) NOT VALID;
...
ALTER TABLE "entity_visits" ADD CONSTRAINT "entity_visits_contractor_id_fkey" FOREIGN KEY ("contractor_id_gen") REFERENCES "entity_master_contractors"(id) NOT VALID;
...
ALTER TABLE "entity_visits" ADD CONSTRAINT "entity_visits_vendor_id_fkey" FOREIGN KEY ("vendor_id_gen") REFERENCES "entity_master_vendors"(id) NOT VALID;
...
ALTER TABLE "entity_tasks" ADD CONSTRAINT "entity_tasks_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_tasks" ADD CONSTRAINT "entity_tasks_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_tasks" ADD CONSTRAINT "entity_tasks_quotation_id_fkey" FOREIGN KEY ("quotation_id_gen") REFERENCES "entity_quotations"(id) NOT VALID;
...
ALTER TABLE "entity_tasks" ADD CONSTRAINT "entity_tasks_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_tasks" ADD CONSTRAINT "entity_tasks_visit_id_fkey" FOREIGN KEY ("visit_id_gen") REFERENCES "entity_visits"(id) NOT VALID;
...
ALTER TABLE "entity_tasks" ADD CONSTRAINT "entity_tasks_po_id_fkey" FOREIGN KEY ("po_id_gen") REFERENCES "entity_purchaseOrders"(id) NOT VALID;
...
ALTER TABLE "entity_tasks" ADD CONSTRAINT "entity_tasks_work_required_id_fkey" FOREIGN KEY ("work_required_id_gen") REFERENCES "entity_workRequired"(id) NOT VALID;
...
ALTER TABLE "entity_followups" ADD CONSTRAINT "entity_followups_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_followups" ADD CONSTRAINT "entity_followups_quotation_id_fkey" FOREIGN KEY ("quotation_id_gen") REFERENCES "entity_quotations"(id) NOT VALID;
...
ALTER TABLE "entity_followups" ADD CONSTRAINT "entity_followups_payment_id_fkey" FOREIGN KEY ("payment_id_gen") REFERENCES "entity_payments"(id) NOT VALID;
...
ALTER TABLE "entity_followups" ADD CONSTRAINT "entity_followups_visit_id_fkey" FOREIGN KEY ("visit_id_gen") REFERENCES "entity_visits"(id) NOT VALID;
...
ALTER TABLE "entity_followups" ADD CONSTRAINT "entity_followups_work_required_id_fkey" FOREIGN KEY ("work_required_id_gen") REFERENCES "entity_workRequired"(id) NOT VALID;
...
ALTER TABLE "entity_actions" ADD CONSTRAINT "entity_actions_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_payments" ADD CONSTRAINT "entity_payments_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_payments" ADD CONSTRAINT "entity_payments_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_payments" ADD CONSTRAINT "entity_payments_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_payments" ADD CONSTRAINT "entity_payments_quotation_id_fkey" FOREIGN KEY ("quotation_id_gen") REFERENCES "entity_quotations"(id) NOT VALID;
...
ALTER TABLE "entity_payments" ADD CONSTRAINT "entity_payments_work_required_id_fkey" FOREIGN KEY ("work_required_id_gen") REFERENCES "entity_workRequired"(id) NOT VALID;
...
ALTER TABLE "entity_payments" ADD CONSTRAINT "entity_payments_invoice_id_fkey" FOREIGN KEY ("invoice_id_gen") REFERENCES "entity_invoices"(id) NOT VALID;
...
ALTER TABLE "entity_invoices" ADD CONSTRAINT "entity_invoices_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_invoices" ADD CONSTRAINT "entity_invoices_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_invoices" ADD CONSTRAINT "entity_invoices_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_invoices" ADD CONSTRAINT "entity_invoices_quotation_id_fkey" FOREIGN KEY ("quotation_id_gen") REFERENCES "entity_quotations"(id) NOT VALID;
...
ALTER TABLE "entity_invoices" ADD CONSTRAINT "entity_invoices_work_required_id_fkey" FOREIGN KEY ("work_required_id_gen") REFERENCES "entity_workRequired"(id) NOT VALID;
...
ALTER TABLE "entity_invoices" ADD CONSTRAINT "entity_invoices_payment_id_fkey" FOREIGN KEY ("payment_id_gen") REFERENCES "entity_payments"(id) NOT VALID;
...
ALTER TABLE "entity_customerReceipts" ADD CONSTRAINT "entity_customerReceipts_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_customerReceipts" ADD CONSTRAINT "entity_customerReceipts_invoice_id_fkey" FOREIGN KEY ("invoice_id_gen") REFERENCES "entity_invoices"(id) NOT VALID;
...
ALTER TABLE "entity_customerReceipts" ADD CONSTRAINT "entity_customerReceipts_payment_id_fkey" FOREIGN KEY ("payment_id_gen") REFERENCES "entity_payments"(id) NOT VALID;
...
ALTER TABLE "entity_customerReceipts" ADD CONSTRAINT "entity_customerReceipts_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_customerReceipts" ADD CONSTRAINT "entity_customerReceipts_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_blocked" ADD CONSTRAINT "entity_blocked_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_blocked" ADD CONSTRAINT "entity_blocked_linked_work_order_id_fkey" FOREIGN KEY ("linked_work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_blocked" ADD CONSTRAINT "entity_blocked_linked_po_id_fkey" FOREIGN KEY ("linked_po_id_gen") REFERENCES "entity_purchaseOrders"(id) NOT VALID;
...
ALTER TABLE "entity_blocked" ADD CONSTRAINT "entity_blocked_linked_grn_id_fkey" FOREIGN KEY ("linked_grn_id_gen") REFERENCES "entity_grns"(id) NOT VALID;
...
ALTER TABLE "entity_blocked" ADD CONSTRAINT "entity_blocked_linked_task_id_fkey" FOREIGN KEY ("linked_task_id_gen") REFERENCES "entity_tasks"(id) NOT VALID;
...
ALTER TABLE "entity_risks" ADD CONSTRAINT "entity_risks_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_commSends" ADD CONSTRAINT "entity_commSends_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_commSends" ADD CONSTRAINT "entity_commSends_followup_id_fkey" FOREIGN KEY ("followup_id_gen") REFERENCES "entity_followups"(id) NOT VALID;
...
ALTER TABLE "entity_commSends" ADD CONSTRAINT "entity_commSends_task_id_fkey" FOREIGN KEY ("task_id_gen") REFERENCES "entity_tasks"(id) NOT VALID;
...
ALTER TABLE "entity_commSends" ADD CONSTRAINT "entity_commSends_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_commSends" ADD CONSTRAINT "entity_commSends_quotation_id_fkey" FOREIGN KEY ("quotation_id_gen") REFERENCES "entity_quotations"(id) NOT VALID;
...
ALTER TABLE "entity_attendance" ADD CONSTRAINT "entity_attendance_staff_id_fkey" FOREIGN KEY ("staff_id_gen") REFERENCES "entity_master_staff"(id) NOT VALID;
...
ALTER TABLE "entity_attendance" ADD CONSTRAINT "entity_attendance_visit_id_fkey" FOREIGN KEY ("visit_id_gen") REFERENCES "entity_visits"(id) NOT VALID;
...
ALTER TABLE "entity_staffLocationPings" ADD CONSTRAINT "entity_staffLocationPings_staff_id_fkey" FOREIGN KEY ("staff_id_gen") REFERENCES "entity_master_staff"(id) NOT VALID;
...
ALTER TABLE "entity_leaveRequests" ADD CONSTRAINT "entity_leaveRequests_staff_id_fkey" FOREIGN KEY ("staff_id_gen") REFERENCES "entity_master_staff"(id) NOT VALID;
...
ALTER TABLE "entity_payrollLines" ADD CONSTRAINT "entity_payrollLines_payroll_period_id_fkey" FOREIGN KEY ("payroll_period_id_gen") REFERENCES "entity_payrollPeriods"(id) NOT VALID;
...
ALTER TABLE "entity_payrollLines" ADD CONSTRAINT "entity_payrollLines_staff_id_fkey" FOREIGN KEY ("staff_id_gen") REFERENCES "entity_master_staff"(id) NOT VALID;
...
ALTER TABLE "entity_salaryAdjustments" ADD CONSTRAINT "entity_salaryAdjustments_staff_id_fkey" FOREIGN KEY ("staff_id_gen") REFERENCES "entity_master_staff"(id) NOT VALID;
...
ALTER TABLE "entity_salaryAdjustments" ADD CONSTRAINT "entity_salaryAdjustments_payroll_period_id_fkey" FOREIGN KEY ("payroll_period_id_gen") REFERENCES "entity_payrollPeriods"(id) NOT VALID;
...
ALTER TABLE "entity_staffDocuments" ADD CONSTRAINT "entity_staffDocuments_staff_id_fkey" FOREIGN KEY ("staff_id_gen") REFERENCES "entity_master_staff"(id) NOT VALID;
...
ALTER TABLE "entity_staffDocuments" ADD CONSTRAINT "entity_staffDocuments_file_asset_id_fkey" FOREIGN KEY ("file_asset_id_gen") REFERENCES "entity_master_fileAssets"(id) NOT VALID;
...
ALTER TABLE "entity_recurringTasks" ADD CONSTRAINT "entity_recurringTasks_assignee_id_fkey" FOREIGN KEY ("assignee_id_gen") REFERENCES "entity_master_staff"(id) NOT VALID;
...
ALTER TABLE "entity_entityFileAttachments" ADD CONSTRAINT "entity_entityFileAttachments_file_asset_id_fkey" FOREIGN KEY ("file_asset_id_gen") REFERENCES "entity_master_fileAssets"(id) NOT VALID;
...
ALTER TABLE "entity_entityReferenceAssignments" ADD CONSTRAINT "entity_entityReferenceAssignments_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_master_vendorRates" ADD CONSTRAINT "entity_master_vendorRates_vendor_id_fkey" FOREIGN KEY ("vendor_id_gen") REFERENCES "entity_master_vendors"(id) NOT VALID;
...
ALTER TABLE "entity_master_vendorRates" ADD CONSTRAINT "entity_master_vendorRates_work_required_article_id_fkey" FOREIGN KEY ("work_required_article_id_gen") REFERENCES "entity_master_subcategoryArticleMap"(id) NOT VALID;
...
ALTER TABLE "entity_master_vendorRates" ADD CONSTRAINT "entity_master_vendorRates_article_id_fkey" FOREIGN KEY ("article_id_gen") REFERENCES "entity_master_articles"(id) NOT VALID;
...
ALTER TABLE "entity_master_vendorRateHistories" ADD CONSTRAINT "entity_master_vendorRateHistories_vendor_rate_id_fkey" FOREIGN KEY ("vendor_rate_id_gen") REFERENCES "entity_master_vendorRates"(id) NOT VALID;
...
ALTER TABLE "entity_master_vendorRateHistories" ADD CONSTRAINT "entity_master_vendorRateHistories_vendor_id_fkey" FOREIGN KEY ("vendor_id_gen") REFERENCES "entity_master_vendors"(id) NOT VALID;
...
ALTER TABLE "entity_master_vendorRateHistories" ADD CONSTRAINT "entity_master_vendorRateHistories_article_id_fkey" FOREIGN KEY ("article_id_gen") REFERENCES "entity_master_articles"(id) NOT VALID;
...
ALTER TABLE "entity_master_vendorRateHistories" ADD CONSTRAINT "entity_master_vendorRateHistories_work_required_article_id_f" FOREIGN KEY ("work_required_article_id_gen") REFERENCES "entity_master_subcategoryArticleMap"(id) NOT VALID;
...
ALTER TABLE "entity_master_contractorRates" ADD CONSTRAINT "entity_master_contractorRates_contractor_id_fkey" FOREIGN KEY ("contractor_id_gen") REFERENCES "entity_master_contractors"(id) NOT VALID;
...
ALTER TABLE "entity_master_articleVariants" ADD CONSTRAINT "entity_master_articleVariants_article_id_fkey" FOREIGN KEY ("article_id_gen") REFERENCES "entity_master_articles"(id) NOT VALID;
...
ALTER TABLE "entity_master_articleVariants" ADD CONSTRAINT "entity_master_articleVariants_work_required_article_id_fkey" FOREIGN KEY ("work_required_article_id_gen") REFERENCES "entity_master_subcategoryArticleMap"(id) NOT VALID;
...
ALTER TABLE "entity_master_subcategoryArticleMap" ADD CONSTRAINT "entity_master_subcategoryArticleMap_article_id_fkey" FOREIGN KEY ("article_id_gen") REFERENCES "entity_master_articles"(id) NOT VALID;
...
ALTER TABLE "entity_master_subcategoryArticleMap" ADD CONSTRAINT "entity_master_subcategoryArticleMap_work_required_id_fkey" FOREIGN KEY ("work_required_id_gen") REFERENCES "entity_master_workSubcategories"(id) NOT VALID;
...
ALTER TABLE "entity_master_storageFolderInstances" ADD CONSTRAINT "entity_master_storageFolderInstances_storage_account_id_fkey" FOREIGN KEY ("storage_account_id_gen") REFERENCES "entity_master_storageAccounts"(id) NOT VALID;
...
ALTER TABLE "entity_master_storageFolderInstances" ADD CONSTRAINT "entity_master_storageFolderInstances_template_id_fkey" FOREIGN KEY ("template_id_gen") REFERENCES "entity_master_storageFolderTemplates"(id) NOT VALID;
...
ALTER TABLE "entity_master_fileAssets" ADD CONSTRAINT "entity_master_fileAssets_storage_account_id_fkey" FOREIGN KEY ("storage_account_id_gen") REFERENCES "entity_master_storageAccounts"(id) NOT VALID;
...
ALTER TABLE "entity_master_fileAssets" ADD CONSTRAINT "entity_master_fileAssets_storage_folder_instance_id_fkey" FOREIGN KEY ("storage_folder_instance_id_gen") REFERENCES "entity_master_storageFolderInstances"(id) NOT VALID;
...
ALTER TABLE "entity_master_catalogueArticleVendorLinks" ADD CONSTRAINT "entity_master_catalogueArticleVendorLinks_catalogue_id_fkey" FOREIGN KEY ("catalogue_id_gen") REFERENCES "entity_master_catalogues"(id) NOT VALID;
...
ALTER TABLE "entity_master_catalogueArticleVendorLinks" ADD CONSTRAINT "entity_master_catalogueArticleVendorLinks_article_id_fkey" FOREIGN KEY ("article_id_gen") REFERENCES "entity_master_articles"(id) NOT VALID;
...
ALTER TABLE "entity_master_catalogueArticleVendorLinks" ADD CONSTRAINT "entity_master_catalogueArticleVendorLinks_vendor_id_fkey" FOREIGN KEY ("vendor_id_gen") REFERENCES "entity_master_vendors"(id) NOT VALID;
...
ALTER TABLE "entity_master_commissionRules" ADD CONSTRAINT "entity_master_commissionRules_source_partner_id_fkey" FOREIGN KEY ("source_partner_id_gen") REFERENCES "entity_master_sourcePartners"(id) NOT VALID;
...
ALTER TABLE "entity_master_commissionRules" ADD CONSTRAINT "entity_master_commissionRules_category_id_fkey" FOREIGN KEY ("category_id_gen") REFERENCES "entity_master_workCategories"(id) NOT VALID;
...
ALTER TABLE "entity_master_pinterestBoards" ADD CONSTRAINT "entity_master_pinterestBoards_category_id_fkey" FOREIGN KEY ("category_id_gen") REFERENCES "entity_master_workCategories"(id) NOT VALID;
...
ALTER TABLE "entity_master_pinterestBoards" ADD CONSTRAINT "entity_master_pinterestBoards_subcategory_id_fkey" FOREIGN KEY ("subcategory_id_gen") REFERENCES "entity_master_workSubcategories"(id) NOT VALID;
...
ALTER TABLE "entity_master_pinterestBoards" ADD CONSTRAINT "entity_master_pinterestBoards_article_id_fkey" FOREIGN KEY ("article_id_gen") REFERENCES "entity_master_articles"(id) NOT VALID;
...
ALTER TABLE "entity_master_referenceMedia" ADD CONSTRAINT "entity_master_referenceMedia_category_id_fkey" FOREIGN KEY ("category_id_gen") REFERENCES "entity_master_workCategories"(id) NOT VALID;
...
ALTER TABLE "entity_master_referenceMedia" ADD CONSTRAINT "entity_master_referenceMedia_subcategory_id_fkey" FOREIGN KEY ("subcategory_id_gen") REFERENCES "entity_master_workSubcategories"(id) NOT VALID;
...
ALTER TABLE "entity_master_referenceMedia" ADD CONSTRAINT "entity_master_referenceMedia_article_id_fkey" FOREIGN KEY ("article_id_gen") REFERENCES "entity_master_articles"(id) NOT VALID;
...
ALTER TABLE "entity_master_catalogues" ADD CONSTRAINT "entity_master_catalogues_drive_asset_id_fkey" FOREIGN KEY ("drive_asset_id_gen") REFERENCES "entity_master_fileAssets"(id) NOT VALID;
...
ALTER TABLE "entity_visits" ADD CONSTRAINT "entity_visits_recovery_followup_id_fkey" FOREIGN KEY ("recovery_followup_id_gen") REFERENCES "entity_followups"(id) NOT VALID;
...
ALTER TABLE "entity_payments" ADD CONSTRAINT "entity_payments_milestone_term_id_fkey" FOREIGN KEY ("milestone_term_id_gen") REFERENCES "entity_paymentTermTemplates"(id) NOT VALID;
...
ALTER TABLE "entity_customers" ADD CONSTRAINT "entity_customers_source_partner_id_fkey" FOREIGN KEY ("source_partner_id_gen") REFERENCES "entity_master_sourcePartners"(id) NOT VALID;
...
ALTER TABLE "entity_sites" ADD CONSTRAINT "entity_sites_source_partner_id_fkey" FOREIGN KEY ("source_partner_id_gen") REFERENCES "entity_master_sourcePartners"(id) NOT VALID;
...
ALTER TABLE "entity_acceptedScopes" ADD CONSTRAINT "entity_acceptedScopes_contractor_bid_id_fkey" FOREIGN KEY ("contractor_bid_id_gen") REFERENCES "entity_contractorBids"(id) NOT VALID;
...
ALTER TABLE "entity_contractorSettlements" ADD CONSTRAINT "entity_contractorSettlements_replacement_work_order_id_fkey" FOREIGN KEY ("replacement_work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_leaveRequests" ADD CONSTRAINT "entity_leaveRequests_approved_by_staff_id_fkey" FOREIGN KEY ("approved_by_staff_id_gen") REFERENCES "entity_master_staff"(id) NOT VALID;
...
ALTER TABLE "entity_attendance" ADD CONSTRAINT "entity_attendance_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_salaryAdjustments" ADD CONSTRAINT "entity_salaryAdjustments_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_recurringTasks" ADD CONSTRAINT "entity_recurringTasks_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_recurringTasks" ADD CONSTRAINT "entity_recurringTasks_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_recurringTasks" ADD CONSTRAINT "entity_recurringTasks_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
...
ALTER TABLE "entity_blocked" ADD CONSTRAINT "entity_blocked_linked_quotation_id_fkey" FOREIGN KEY ("linked_quotation_id_gen") REFERENCES "entity_quotations"(id) NOT VALID;
...
ALTER TABLE "entity_auditLog" ADD CONSTRAINT "entity_auditLog_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_master_fileAssets" ADD CONSTRAINT "entity_master_fileAssets_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_master_fileAssets" ADD CONSTRAINT "entity_master_fileAssets_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_master_storageFolderInstances" ADD CONSTRAINT "entity_master_storageFolderInstances_customer_id_fkey" FOREIGN KEY ("customer_id_gen") REFERENCES "entity_customers"(id) NOT VALID;
...
ALTER TABLE "entity_master_storageFolderInstances" ADD CONSTRAINT "entity_master_storageFolderInstances_site_id_fkey" FOREIGN KEY ("site_id_gen") REFERENCES "entity_sites"(id) NOT VALID;
...
ALTER TABLE "entity_master_storageFolderInstances" ADD CONSTRAINT "entity_master_storageFolderInstances_work_order_id_fkey" FOREIGN KEY ("work_order_id_gen") REFERENCES "entity_workOrders"(id) NOT VALID;
