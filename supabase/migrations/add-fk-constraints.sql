...
ALTER TABLE entity_sites ADD CONSTRAINT sites_customer_fkey FOREIGN KEY (customer_id_gen) REFERENCES entity_customers(id) ON DELETE CASCADE;
...
ALTER TABLE entity_areas ADD CONSTRAINT areas_site_fkey FOREIGN KEY (site_id_gen) REFERENCES entity_sites(id) ON DELETE CASCADE;
...
ALTER TABLE entity_workRequired ADD CONSTRAINT wr_customer_fkey FOREIGN KEY (customer_id_gen) REFERENCES entity_customers(id) ON DELETE RESTRICT;
ALTER TABLE entity_workRequired DROP CONSTRAINT IF EXISTS wr_site_fkey;
ALTER TABLE entity_workRequired ADD CONSTRAINT wr_site_fkey FOREIGN KEY (site_id_gen) REFERENCES entity_sites(id) ON DELETE RESTRICT;
...
ALTER TABLE entity_quotations ADD CONSTRAINT quot_customer_fkey FOREIGN KEY (customer_id_gen) REFERENCES entity_customers(id) ON DELETE RESTRICT;
ALTER TABLE entity_quotations DROP CONSTRAINT IF EXISTS quot_site_fkey;
ALTER TABLE entity_quotations ADD CONSTRAINT quot_site_fkey FOREIGN KEY (site_id_gen) REFERENCES entity_sites(id) ON DELETE RESTRICT;
...
ALTER TABLE entity_workOrders ADD CONSTRAINT wo_customer_fkey FOREIGN KEY (customer_id_gen) REFERENCES entity_customers(id) ON DELETE RESTRICT;
ALTER TABLE entity_workOrders DROP CONSTRAINT IF EXISTS wo_site_fkey;
ALTER TABLE entity_workOrders ADD CONSTRAINT wo_site_fkey FOREIGN KEY (site_id_gen) REFERENCES entity_sites(id) ON DELETE RESTRICT;
...
ALTER TABLE entity_boqs ADD CONSTRAINT boq_wo_fkey FOREIGN KEY (work_order_id_gen) REFERENCES entity_workOrders(id) ON DELETE CASCADE;
...
ALTER TABLE entity_executionLogs ADD CONSTRAINT elog_wo_fkey FOREIGN KEY (work_order_id_gen) REFERENCES entity_workOrders(id) ON DELETE CASCADE;
...
ALTER TABLE entity_purchaseOrders ADD CONSTRAINT po_wo_fkey FOREIGN KEY (work_order_id_gen) REFERENCES entity_workOrders(id) ON DELETE SET NULL;
...
ALTER TABLE entity_grns ADD CONSTRAINT grn_po_fkey FOREIGN KEY (po_id_gen) REFERENCES entity_purchaseOrders(id) ON DELETE CASCADE;
...
ALTER TABLE entity_contractorBills ADD CONSTRAINT cbill_wo_fkey FOREIGN KEY (work_order_id_gen) REFERENCES entity_workOrders(id) ON DELETE RESTRICT;
...
ALTER TABLE entity_contractorPayments ADD CONSTRAINT cpay_cbill_fkey FOREIGN KEY (contractor_bill_id_gen) REFERENCES entity_contractorBills(id) ON DELETE CASCADE;
...
ALTER TABLE entity_invoices ADD CONSTRAINT inv_customer_fkey FOREIGN KEY (customer_id_gen) REFERENCES entity_customers(id) ON DELETE RESTRICT;
...
ALTER TABLE entity_payments ADD CONSTRAINT pay_customer_fkey FOREIGN KEY (customer_id_gen) REFERENCES entity_customers(id) ON DELETE RESTRICT;
...
ALTER TABLE entity_master_contractorRates ADD CONSTRAINT crate_contractor_fkey FOREIGN KEY (contractor_id_gen) REFERENCES entity_master_contractors(id) ON DELETE CASCADE;
...
ALTER TABLE entity_master_vendorRates ADD CONSTRAINT vrate_vendor_fkey FOREIGN KEY (vendor_id_gen) REFERENCES entity_master_vendors(id) ON DELETE CASCADE;
...
ALTER TABLE entity_master_storageFolderInstances ADD CONSTRAINT sfi_account_fkey FOREIGN KEY (storage_account_id_gen) REFERENCES entity_master_storageAccounts(id) ON DELETE RESTRICT;
